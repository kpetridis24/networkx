...
class TestGraphSUBVF2pp:
    ...
    def test_graph_same_labels(self):
        ...
        l1, l3 = get_labels(G1, G3)
        m = VF2pp(G1, G3, l1, l3, PT=self.PT)
        assert m
    ...
    def test_graph_DB_same_labels(self):
        ...
        l1, l2 = get_labels(graph, subgraph)
        m = VF2pp(graph, subgraph, l1, l2, PT=self.PT)
        assert m
    ...
    def test_custom_graph1_same_labels(self):
        ...
        m = VF2pp(G1, g2, l1, l2, PT=self.PT)
        assert m
        ...
        l2, l4 = get_labels(G2, g4)
        m = VF2pp(G2, g4, l2, l4, PT=self.PT)
        assert m
    ...
    def test_custom_graph2_same_labels(self):
        ...
        m = VF2pp(G2, g1, l2, l1, PT=self.PT)
